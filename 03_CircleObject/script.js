...
cirkleObject.draw = function(){
    ...
    else if(cirkleObject.y - cirkleObject.radius <= 0) {
        cirkleObject.velocity_y = -cirkleObject.velocity_y;
    }
    
    else if(cirkleObject.x + cirkleObject.radius >= window.innerWidth) {
        cirkleObject.velocity_x = -cirkleObject.velocity_x;
    }
    
    else if(cirkleObject.y + cirkleObject.radius >= window.innerHeight) {
        cirkleObject.velocity_y = -cirkleObject.velocity_y;
    }
